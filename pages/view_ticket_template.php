...
hx-swap-oob="true"
        ...
        hx-post="htmx_message?ticket_id=<?=$ticket->id?>" hx-target="#chat" hx-swap="innerHTML" hx-trigger="every 3s">
      ...
      <!-- MESSAGE INPUT -->
      <?php if($ticket->status_id != 4) { ?>
      <form id="message_form" method="post" hx-post="htmx_message?ticket_id=<?=$ticket->id?>" hx-target="#chat" hx-swap="innerHTML" hx-trigger="submit" hx-on::after-request="this.reset()">
